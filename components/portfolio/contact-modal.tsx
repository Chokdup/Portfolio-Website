    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Glow effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-primary/30 via-primary/20 to-accent/30 rounded-2xl blur-xl opacity-60" />
            
            {/* Modal content */}
            <div className="relative bg-card/95 backdrop-blur-xl rounded-2xl border border-primary/30 shadow-2xl shadow-primary/10 overflow-hidden">
              {/* Header */}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          required
                          className="bg-background/60 border-2 border-primary/20 focus:border-primary hover:border-primary/40 transition-all placeholder:text-muted-foreground/50 h-11"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        required
                        className="bg-background/60 border-2 border-primary/20 focus:border-primary hover:border-primary/40 transition-all placeholder:text-muted-foreground/50 resize-none"
                      />
                    </div>
